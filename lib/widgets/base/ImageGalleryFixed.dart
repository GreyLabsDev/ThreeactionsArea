...
// Old and more stable version of image gallery widget

class ImageGalleryFixed extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SimpleGalleryFixedState();
  }
}

class SimpleGalleryFixedState extends State {
  var widthsList = [];
  var hoveredIndex = -1;
  var baseWidth = 0.0;
